...
import type { ExternalBlob as _ExternalBlob, ReligiousPractice as _ReligiousPractice, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPractice(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPractice(arg0, arg1, arg2, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPractices(): Promise<Array<ReligiousPractice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPractices();
    ...
    async getPracticeById(arg0: bigint): Promise<ReligiousPractice | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPracticeById(arg0);
    ...
    async getPracticesByDeity(arg0: string): Promise<Array<ReligiousPractice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPracticesByDeity(arg0);
                return from_candid_vec_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPracticesByRitualType(arg0: string): Promise<Array<ReligiousPractice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPracticesByRitualType(arg0);
                return from_candid_vec_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPracticesByTradition(arg0: string): Promise<Array<ReligiousPractice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPracticesByTradition(arg0);
                return from_candid_vec_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ReligiousPractice_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ReligiousPractice): Promise<ReligiousPractice> {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ReligiousPractice]): Promise<ReligiousPractice | null> {
    return value.length === 0 ? null : await from_candid_ReligiousPractice_n10(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        associatedDeity: value.associatedDeity,
...
async function from_candid_vec_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ReligiousPractice>): Promise<Array<ReligiousPractice>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ReligiousPractice_n10(_uploadFile, _downloadFile, x)));
}
